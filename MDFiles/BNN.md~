...
- [Towards Accurate Binary Convolutional Neural Network](https://arxiv.org/abs/1711.11294): DJI's paper on binary neural nets for accurate results (as accurate as real counterparts).
